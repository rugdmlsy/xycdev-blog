...
<body data-page="article" data-post-slug="${escapeAttr(post.slug)}">
  ...
  <main id="article" class="article-shell">
    ...
    <header class="article-header">
      ...
      <div class="article-info"><time datetime="${post.date}">${displayDate(post.date)}</time><span data-language-copy="zh">${post.readMinutes} 分钟阅读</span><span data-language-copy="en" hidden>${post.readMinutes} min read</span>${renderTags(tags)}</div>
    </header>
