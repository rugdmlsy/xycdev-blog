...
const assertions = [
  ...
  [giscusLight.includes('--color-canvas-default: #f4ecd9') && giscusLight.includes('background-color: #f4ecd9 !important') && giscusLight.includes('.gsc-reactions-popover') && giscusLight.includes('--color-accent-fg: #8f2d24'), 'Giscus light palette is missing'],
  [giscusDark.includes('--color-canvas-default: #1d1d1a') && giscusDark.includes('background-color: #1d1d1a !important') && giscusDark.includes('--color-accent-fg: #d27a6e'), 'Giscus dark palette is missing'],
  [home.includes('/styles.css?v=20260802-11') && article.includes('/script.js?v=20260802-11'), 'Versioned production assets are missing'],
