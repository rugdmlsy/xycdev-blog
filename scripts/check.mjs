...
const assertions = [
  ...
  [giscusLight.includes('--color-canvas-default: #f4ecd9') && giscusLight.includes('background-image: url("https://blog.xycdev.com/assets/parchment-surface.webp")') && giscusLight.includes('background-blend-mode: soft-light') && giscusLight.includes('.gsc-reactions-popover') && giscusLight.includes('--color-accent-fg: #8f2d24'), 'Giscus light palette is missing'],
  [giscusDark.includes('--color-canvas-default: #1d1d1a') && giscusDark.includes('background-image: url("https://blog.xycdev.com/assets/parchment-surface.webp")') && giscusDark.includes('background-blend-mode: multiply') && giscusDark.includes('--color-accent-fg: #d27a6e'), 'Giscus dark palette is missing'],
  [home.includes('/styles.css?v=20260802-12') && article.includes('/script.js?v=20260802-12'), 'Versioned production assets are missing'],
