...
const assertions = [
  ...
  [styles.includes('0.9% 0%, 99.1% 0%') && styles.includes('0.9% 100%'), 'Straight horizontal parchment edges are missing'],
  [styles.includes('97.38% 33%') && styles.includes('2.42% 38%'), 'Torn left and right parchment edges are missing'],
