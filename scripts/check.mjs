...
const assertions = [
  ...
  [home.includes('/styles.css?v=20260802-2') && home.includes('/script.js?v=20260802-2') && article.includes('/styles.css?v=20260802-2') && article.includes('/script.js?v=20260802-2'), 'Versioned static assets are missing'],
  [styles.includes('@media (max-width: 680px)'), 'Mobile styles are missing'],
  [styles.includes('overflow-x: clip;'), 'Viewport-width overflow clipping is missing'],
  [styles.includes('top: 64px;') && styles.includes('z-index: 10;'), 'Safe sticky table-of-contents offset is missing'],
  [script.includes("window.addEventListener('scroll', updateReadingProgress") && !script.includes('scheduleReadingProgress'), 'Direction-independent reading progress updates are missing'],
