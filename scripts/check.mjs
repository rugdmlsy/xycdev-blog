...
const assertions = [
  ...
  [giscusLight.includes('--color-canvas-default: #f4ecd9') && giscusLight.includes('--color-canvas-overlay: #eee5d3') && giscusLight.includes('.gsc-reactions-popover') && giscusLight.includes('--color-accent-fg: #8f2d24'), 'Giscus light palette is missing'],
  ...
  [home.includes('/styles.css?v=20260802-10') && article.includes('/script.js?v=20260802-10'), 'Versioned production assets are missing'],
