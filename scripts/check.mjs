...
const assertions = [
  ...
  [article.includes('class="article-paper-stack"'), 'Stacked parchment wrapper is missing'],
  ...
  [styles.includes('.article-paper-stack::before') && styles.includes('.article-paper-stack::after'), 'Layered upper parchment edge is missing'],
  [styles.includes('0 17px 0 var(--parchment-card-layer-deep)'), 'Heavy lower parchment thickness is missing'],
  [styles.includes("surfaceScale='22'"), 'Pronounced crumple relief is missing'],
